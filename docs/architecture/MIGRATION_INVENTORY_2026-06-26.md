...
Target skeleton: `/Users/vincenzobarone/MATRIX`
...
- active code changes in `matrix_core/cli.py`, `matrix_morpheus/__init__.py`,
  `matrix_morpheus/tests/test_ensemble.py` and new reference-library files;
...
- `gui -> matrix_morpheus`
- `gui -> geometry`
- `topology -> matrix_morpheus`
- `matrix_morpheus -> topology`
- `matrix_neo -> matrix_morpheus`
- `matrix_morpheus -> matrix_morpheus`
- `matrix_morpheus -> geometry`
...
- `matrix_vpt2_vci`
- `matrix_oracle`
- stable parts of `geometry`, `topology` and `matrix_morpheus`
- `geometry/rotational_pipeline.py`, `geometry/vibrational.py`,
  `geometry/vib_anh.py`, `geometry/rovib_pipeline.py`,
  `geometry/coriolis.py` and `geometry/qcent.py` as `matrix-rovib` sources
- `geometry/thermo_trasl.py`, `geometry/thermo_rot.py`,
  `geometry/thermo_vib.py`, `geometry/thermo_pipeline.py` and
  `geometry/thermo_writer.py` as `matrix-thermo` sources
- `matrix_morpheus/topology`, especially `AtomicSynthons`,
...
MATRIX preprocessing workspace in the same command.
