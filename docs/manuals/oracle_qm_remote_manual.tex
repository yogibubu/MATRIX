...
All Gaussian inputs generated by MATRIX include \texttt{output=pickett}; this
keeps rotational and hyperfine constants in the form consumed by Pickett/SPFIT
and by the MATRIX rovibrational adapters.
