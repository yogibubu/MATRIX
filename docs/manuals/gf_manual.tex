...
coordinate definition and the QM result separate.  The GICs are rebuilt and
stored by NEO/MATRIX; the Gaussian log contributes only Hessian and normal-mode
data:
...
GIC definition.  This prevents GF/PED from depending on coordinates that might
have been edited, reordered or generated by a different Gaussian-side tool.
The only accepted GIC source is the MATRIX \texttt{\#GIC} section produced by
NEO.
