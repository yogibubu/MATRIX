...
large-amplitude treatments the downstream DVR code uses the corresponding
sub-block of the stored global \(G^{-1}\).
...
\texttt{\detokenize{*_large_amplitude_dvr_plan.csv}} & DVR-ready
