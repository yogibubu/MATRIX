...
when an endocyclic dihedral has a double or partially double central bond, its
coefficient is multiplied by a smaller flexibility factor before the component
is normalized.  The frozen coordinate therefore already carries the increased
rigidity of that ring bond, and GF/DVR planning receives the same bond-order
