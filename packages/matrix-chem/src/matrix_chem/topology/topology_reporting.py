...
try:
    from matrix_neo.survibfit.primitives import build_primitives
    from matrix_neo.survibfit.symmetry_classifier import group_label as _group_label
    from matrix_neo.survibfit.symmetry_detector import (
        is_linear,
        orient_coords,
        symmetry_elements_from_geometry,
    )
    from matrix_neo.survibfit.symmetry_global import primitive_permutation
...
def _symmetry_summary(
    ...
    *,
    ...
    if (
        ...
        raise RuntimeError("matrix_neo.survibfit is required for symmetry primitive reporting")
